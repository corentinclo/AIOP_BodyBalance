...
$(function () {
  ...
  function testAPI(userID) {
    ...
    FB.api("/me/",{fields: 'name ,first_name ,last_name ,hometown,email'}, function(response) {
          //console.log(response);
          var fb_user = {};
          fb_user.name = response.name;
          fb_user.first_name = response.first_name;
          fb_user.last_name = response.last_name;
          fb_user.hometown = response.hometown;
